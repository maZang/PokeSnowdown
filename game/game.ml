(*
COMPILE WITH:
ocamlfind ocamlc -g -thread -package lablgtk2 -package async -linkpkg info.mli data_loader.mli gui.mli pokemon.mli battle_controller.mli game.mli gui.ml pokemon.ml battle_controller.ml game.ml  -o game
*)
