...
let getTestPoke () =
  ...
  {name="gardevoir-mega"; element=[Grass;Flying]; move1= getMoveFromString "brave-bird"; move2 =
  ...
  speed = 120; special_defense = 135; ability="rock-head"; evs; nature; item}
...
let getTestOpp () =
  ...
  let nature = Bold in
  let item = Leftovers in
  {name="gallade-mega"; element=[Grass;Flying]; move1= getMoveFromString "will-o-wisp"; move2 =
